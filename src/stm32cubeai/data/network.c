...
#define AI_NETWORK_MODEL_SIGNATURE     "251607c8101907b4e720f88241ad7963"
...
#define AI_TOOLS_DATE_TIME   "Sun Sep 21 21:29:24 2025"
...
AI_LAYER_OBJ_DECLARE(
  global_average_pooling2d_layer, 16,
  POOL_TYPE, 0x0, NULL,
  pool, forward_ap,
...
AI_LAYER_OBJ_DECLARE(
  depthwise_conv2d_1_conv2d_layer, 12,
  CONV2D_TYPE, 0x0, NULL,
  conv2d, forward_conv2d,
...
AI_LAYER_OBJ_DECLARE(
  depthwise_conv2d_conv2d_layer, 6,
  CONV2D_TYPE, 0x0, NULL,
  conv2d, forward_conv2d,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 38928, 1, 1),
    38928, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 30976, 1, 1),
    30976, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 5888);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5888);
    
    depthwise_conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 18432);
    depthwise_conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 18432);
    
    conv2d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 1024);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1024);
    
    depthwise_conv2d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    depthwise_conv2d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv2d_2_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 6272);
    conv2d_2_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6272);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    depthwise_conv2d_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 640);
    depthwise_conv2d_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 640);
    
    depthwise_conv2d_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    depthwise_conv2d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 1216);
    depthwise_conv2d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1216);
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 19712);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 19712);
    
    depthwise_conv2d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    depthwise_conv2d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 19840);
    depthwise_conv2d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 19840);
    
    depthwise_conv2d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    depthwise_conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 20992);
    depthwise_conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 20992);
    
    conv2d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 21120);
    conv2d_2_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 21120);
    
    conv2d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 29312);
    conv2d_2_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 29312);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 29568);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 29568);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 38784);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 38784);
